...
Add your GPG key to your bash profile for programs to autmatically use it.  4 hex bytes are represented by 8 hex (base-16) bits.  Example: A1B2C3D4 is 4 bytes in hex.
